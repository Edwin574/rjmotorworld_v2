...
const NewCarsPage = () => {
  // Initialize filters with "new" condition
  const initialFilters = { condition: 'new' };
  ...
  // Handle filter changes - maintain the "new" condition
  const handleFilterChange = (newFilters: any) => {
    setFilters({ ...newFilters, condition: 'new' });
  };
  ...
  return (
    <section className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold mb-8">Browse Our New Cars</h1>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
              <div className="text-gray-medium">
                Showing <span className="font-bold">{sortedCars.length}</span> new cars
              </div>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-bold mb-2">No new cars found</h3>
