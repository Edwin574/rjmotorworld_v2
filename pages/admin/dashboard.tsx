...
const AdminDashboardPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Admin Dashboard - RJ Motorworld</title>
        <meta name="description" content="RJ Motorworld Admin Dashboard" />
      </Head>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow p-6 lg:col-span-2">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link href="/admin/cars" className="text-primary hover:underline text-sm">
                    View All
                  </Link>
                </div>
                      ...
                      {Array.isArray(inquiries) ? inquiries.slice(0, 3).map((inquiry: SellInquiry) => (
                        <tr key={inquiry.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 text-sm">
                            <div className="flex space-x-2">
                              <Link href={`/admin/inquiries?view=${inquiry.id}`} className="text-primary hover:text-blue-700">
